...
public class IneraCookieSerializerTest {
    ...
    public void writeCookieValue_samesite_exclusion() {
        ...
        assertEquals("Erroneous samesite attribut for: " + userAgent, isSameSiteNone,
    ...
    public void writeCookieValue_samesite_no_exclusion() {
        ...
        assertEquals("Erroneous samesite attribut for: " + userAgent, true,
            stringCaptor.getValue().contains("SameSite=none"));
    }
    ...
    public void writeCookieValue_samesite_no_isSecure() {
        ...
        assertEquals("Erroneous samesite attribut for: " + userAgent, false,
            stringCaptor.getValue().contains("SameSite=none"));
    }
}