...
public class AbstractLogMessage implements Serializable {
    ...
    static final String RESOURCE_TYPE_INTYG = "Intyg";
    static final String RESOURCE_TYPE_OVERSIKT = "Översikt";
    ...
    public AbstractLogMessage(ActivityType activityType, String resourceType) {
        this(activityType, ActivityPurpose.CARE_TREATMENT, resourceType);
    }

    public AbstractLogMessage(ActivityType activityType) {
        this(activityType, ActivityPurpose.CARE_TREATMENT, RESOURCE_TYPE_INTYG);
    }
