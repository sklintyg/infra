...
public class HsaIntygProxyServiceHealthCareProviderClient {
    ...
    public GetHealthCareProviderResponseDTO get(GetHealthCareProviderRequestDTO request) {
        final var url = intygProxyServiceBaseUrl + getHealthCareProviderEndpoint;
        try {
            return restTemplate.postForObject(url, request, GetHealthCareProviderResponseDTO.class);
