 ...
 * {@link se.inera.intyg.common.integration.hsa.services.HsaPersonService}
 * instead.
 *
...
public interface AuthorizationManagementService {
    ...
    List<CredentialInformationType> getAuthorizationsForPerson(String personHsaId,
            String personalIdentityNumber, String searchBase) throws ExternalServiceCallException;
}
